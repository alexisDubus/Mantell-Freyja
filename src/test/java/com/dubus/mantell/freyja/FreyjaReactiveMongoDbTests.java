package com.dubus.mantell.freyja;

import com.dubus.mantell.freyja.product.controller.ProductController;
...
class FreyjaReactiveMongoDbTests {
    @Autowired
    ...
    public void addProductTest(){
		Mono<ProductDto> productDtoMono=Mono.just(new ProductDto("102","mobile",10000));
		when(service.save(productDtoMono)).thenReturn(productDtoMono);
	...
	public void getProductsTest(){
		Flux<ProductDto> productDtoFlux=Flux.just(new ProductDto("102","mobile",10000),
				new ProductDto("103","TV",50000));
		...
		StepVerifier.create(responseBody)
				.expectSubscription()
				.expectNext(new ProductDto("102","mobile",10000))
				.expectNext(new ProductDto("103","TV",50000))
				.verifyComplete();
